...
class Main {
    public static final Map<String, Map<String, Object>> opts = [
            ...
            pr: [longOpt: 'pull-requests', required: false, args: 1, argName: 'pullRequests', description: "Build Per Pull Request - If the repo resides on GitHub, then support also creating build jobs from pull requests - gradle flag -DpullRequests"]
    ]
